    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-100">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-lg">
        <div className="text-center">
            <div className="flex items-center justify-center mx-auto mb-4 w-20 h-20 bg-blue-100 rounded-full">
                <DocumentTextIcon className="w-12 h-12 text-blue-600"/>
            </div>
          <h1 className="text-3xl font-bold text-slate-800">Si-Pandai</h1>
          <p className="mt-2 text-slate-500">Sistem Pengajuan dan Data Ajuan Institusi</p>
        </div>
